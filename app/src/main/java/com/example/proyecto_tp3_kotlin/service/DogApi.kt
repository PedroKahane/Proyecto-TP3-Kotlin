...
interface DogApi {
    ...
    suspend fun getBreedDogImage(@Path("breed") breed: String): BreedsResponse
    @GET("api/breed/{breed}/{subbreed}/images/random")
    suspend fun getSubBreedDogImage(@Path("breed") breed: String, @Path("subBreed") subBreed: String): BreedsResponse
}